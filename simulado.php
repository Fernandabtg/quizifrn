...
<form action="verificarSimulado.php" method="POST">
		<input type='hidden' name='simulado' value='simulado'/> 
		<br/> <br/>
		<div id="text">
<?php

print "\n<div class='title'><h2>Português</h2></div>";
...
do{
    ...
    if(in_array($nQuestao,$nQuestoes)==false){
		...
		#$aux = $nQuestao." ".$aux;	
		$sql = "select * from qPortugues where id=".$nQuestao;
...
print "\n<div class='title'><h1>Matemática</h1></div>";
